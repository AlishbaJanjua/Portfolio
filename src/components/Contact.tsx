      ...
      <div className="glass-card relative overflow-hidden rounded-3xl px-6 py-16 text-center md:px-16 md:py-20">
        ...
        <Reveal delay={1}>
          <div className="mx-auto mt-10 grid max-w-3xl gap-4 sm:grid-cols-3">
            {links.map((link) => {
              const cardClassName =
                "group flex flex-col items-center gap-3 rounded-2xl border border-white/10 bg-surface p-6 transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:bg-surface-2";
